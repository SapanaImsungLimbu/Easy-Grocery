...
export default function SingleOrder() {
  ...
  return (
    <View className="bg-white h-full flex-1">
            ...
            <View className="flex-row items-center">
              ...
              <View>
                ...
                <View className="flex-row items-center flex-wrap">
                  ...
                  <Text className="text-gray-700 text-base ml-1">{data?.shippingAddress}</Text>
                </View>
                <View className="flex-row items-center">
                  <Text className="text-gray-700 text-base font-semibold mr-1">phoneNumber : {data && data?.phoneNumber}</Text>
                </View>
              </View>
            </View>
          </View>
      ...
      <TouchableOpacity onPress={()=>navigation.navigate('Location',{orderId})} style={{marginTop:30}}>
                <Text style={{textAlign:'center'}}>Go to Maps</Text>
